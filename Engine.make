...
ALL_LDFLAGS += $(LDFLAGS) -Llibs/glfw -Llibs/glew
...
ALL_LDFLAGS += $(LDFLAGS) -Llibs/glfw -Llibs/glew -s
...
$(OBJDIR)/file_utils.o: src/file_utils.c
	@echo "$(notdir $<)"
